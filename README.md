# This is the open-source stack of software components in the project OpenFabTwin
The stack is created as a Docker container architecture. 


## Components
The software stack contains of the following docker images:
- property server datacat (datacat editor, datacat api, datacat restapi, neo4j db)
- MinIO Object Storage
- Keycloak + Postgres DB
- Opensource BIMserver
- BCFserver
